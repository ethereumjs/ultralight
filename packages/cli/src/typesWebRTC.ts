...
export type WebRTCPeer = {
  rtcPeer: typeof wrtc.RTCPeerConnection
  sendChannel: typeof wrtc.RTCDataChannel
  receiveChannel?: typeof wrtc.RTCDataChannel
}
...
export type Offer = typeof wrtc.RTCSessionDescriptionInit
export type Answer = typeof wrtc.RTCSessionDescriptionInit
