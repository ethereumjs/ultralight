...
export const packetTestData: Record<string, testParams> = {
  syn: {
    ...
    data: {
      ...
      extension: 0,
      connectionId: 10049,
      timestampMicroseconds: BigNumber.from(3384187322),
  ...
  ack: {
    ...
    data: {
      ...
      extension: 0,
      connectionId: 10049,
      timestampMicroseconds: BigNumber.from(6195294),
      timestampDifferenceMicroseconds: BigNumber.from(916973699),
      wndSize: BigNumber.from(1048576),
      seqNr: 16807,
      ackNr: 11885,
    },
  ...
  data: {
    ...
    data: {
      ...
      extension: 0,
      connectionId: 26237,
      timestampMicroseconds: BigNumber.from(252492495),
      timestampDifferenceMicroseconds: BigNumber.from(242289855),
  ...
  fin: {
    ...
    data: {
      ...
      extension: 0,
      connectionId: 19003,
      timestampMicroseconds: BigNumber.from(515227279),
      timestampDifferenceMicroseconds: BigNumber.from(511481041),
      wndSize: BigNumber.from(1048576),
      seqNr: 41050,
      ackNr: 16806,
    },
  ...
  reset: {
    ...
    data: {
      ...
      extension: 0,
      connectionId: 62285,
      timestampMicroseconds: BigNumber.from(751226811),
      timestampDifferenceMicroseconds: BigNumber.from(0),
      wndSize: BigNumber.from(0),
      seqNr: 55413,
      ackNr: 16807,
    },
