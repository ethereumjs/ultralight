...
const ShowInfo: React.FC<infoprops> = ({ portal }) => {
  ...
  const [_newLookupMessage, setNewLookupMessage] = useState<string | undefined>()
  ...
  async function perId() {
    const peerId = discv5.enr && (await discv5.enr.peerId())
    setPid(peerId)
  }
          ...
          <ModalBody>
            <div style={row}>
                ...
                <div style={row}>
                  ...
                  <div style={col}>
                    <div style={row}>
                      ...
                      <div style={col}>{toHexString(enr?.getLocationMultiaddr('udp')?.bytes)}</div>
                    </div>
                    <div style={row}>
                      <div style={col}>- string: </div>
                      <div style={col}>{enr?.getLocationMultiaddr('udp')?.toString()}</div>
                    </div>
                    <div style={row}>
                      <div style={col}>- family: </div>
                      <div style={col}>{enr?.getLocationMultiaddr('udp')?.toOptions()?.family}</div>
                    </div>
                    <div style={row}>
                      <div style={col}>- host:</div>
                      <div style={col}> {enr?.getLocationMultiaddr('udp')?.toOptions()?.host}</div>
                    </div>
                    <div style={row}>
                    ...
                    <div style={row}>
                      ...
                      <div style={col}>{enr?.getLocationMultiaddr('udp')?.toOptions()?.port}</div>
                    </div>
                    <div style={row}>
              ...
              <div style={col}>
                ...
                <h2 style={{ textAlign: 'center', fontWeight: 'bold' }}>Ethereum Node Record:</h2>
                <div style={row}>
                  <div style={col}>
                ...
                <h2 style={{ textAlign: 'center', fontWeight: 'bold' }}>publicKey:</h2>
                <div style={row}>
                  <div style={col}>{`0x${enr?.publicKey.toString('hex')}`}</div>
                </div>
                <h2 style={{ textAlign: 'center', fontWeight: 'bold' }}>Signature:</h2>
                <div style={row}>
                ...
                <h2 style={{ textAlign: 'center', fontWeight: 'bold' }}>Peer Id B5BString:</h2>
                <div style={row}>
